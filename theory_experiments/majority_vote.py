...
def q_equals_k(dim, theta_wy, theta_qk=None, nsamples=100_000):
...
emp = np.array([[q_equals_k(dim, theta, theta_qk=theta_qk, nsamples=100_000) for theta in tqdm(thetas)] for theta_qk in [0, np.pi/4, np.pi/3, np.pi/2]])
